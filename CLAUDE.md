...
- The App Store version of Expo Go may lag behind the latest SDK. If you see "Project is incompatible with this version of Expo Go", join the TestFlight beta to get the latest version. See issue [43699](https://github.com/expo/expo/issues/43699).
